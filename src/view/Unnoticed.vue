    ...
    <section v-show="a && a1 && a2 && a3">
      <section :style="{height:newVh}" class="picture_container">
        <div ref="colBox" class="col-box" @wheel="wheel">
          ...
          <img @load="imgLoad" class="pic" src="https://s1.vika.cn/space/2022/10/27/683cc5c0c1c64c8cb004fe10bc5d1547?attname=Un_1.webp" alt="" />
          <img @load="imgLoad2" class="pic" src="https://s1.vika.cn/space/2022/10/27/20fa478eeeac431fb7cc19fdaef29837?attname=Un_7.webp" alt="" />
          <img @load="imgLoad3" class="pic" src="https://s1.vika.cn/space/2022/10/27/c2cd5a7ccd4049e98a69171badde3046?attname=Un_4.webp" alt="" />
          <img @load="imgLoad4" class="pic" src="https://s1.vika.cn/space/2022/10/27/a7ac57465fa845c9ab895181d20dff20?attname=Un_5.webp" alt="" />
